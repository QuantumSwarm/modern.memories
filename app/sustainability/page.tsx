    ...
    <main className="min-h-screen bg-gradient-to-br from-stone-900 via-stone-800 to-stone-950">
      ...
      <section className="pt-32 pb-20 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Mission - Changed bg to stone-800 for contrast */}
          <motion.div
            initial={{ opacity: 0, y: 40 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="bg-stone-800 text-stone-100 rounded-2xl p-8 md:p-12 mb-12 shadow-xl border border-stone-700"
          >
          ...
          {/* Pillars - Kept white for high contrast pop */}
      ...
      <footer className="py-8 px-4 bg-stone-950 text-center text-stone-500 text-sm border-t border-stone-800">
