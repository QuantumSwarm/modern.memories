...
export default function SustainabilityPage() {
  return (
    <main className="min-h-screen bg-gradient-to-br from-stone-50 via-stone-100 to-stone-200">
      <Navbar />
      ...
      <section className="pt-32 pb-20 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="bg-stone-900 text-stone-100 rounded-2xl p-8 md:p-12 mb-12 shadow-xl"
          >
            ...
            <p className="text-stone-300 text-lg leading-relaxed">
              ...
              practices and high fashion are not mutually exclusive—they are inseparable.
            </p>
          </motion.div>
          ...
          >
            <a
              href="/rsvp"
              className="inline-block px-8 py-4 bg-pink-500 hover:bg-pink-400 text-white font-medium rounded-full transition-all hover:scale-105 shadow-lg"
            >
      ...
      <footer className="py-8 px-4 bg-stone-900 text-center text-stone-400 text-sm">
